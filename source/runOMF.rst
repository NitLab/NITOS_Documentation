...
You can run OMF experiments while logged in the NITOS server with your account. All you have to do is use the *--slice username* option when running the *omf exec* command (replacing username with your actual slice_name).
