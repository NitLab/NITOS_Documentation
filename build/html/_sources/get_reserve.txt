...
Slice names typically coincide with your NITlab site's account username.For example if your username is **"syiordan"** then your slice's name will probably be **"syiordan"**.In next topics we will assume that your slice is named **username**. You should replace this value with your slice’s actual name whenever you encounter it.
